...
export const FooterComponent = () => {
  return (
    <footer className="text-[#f8583e] body-font mt-3 w-full">
            <div className="bg-black ">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row justify-between">
                    <p className="text-[#f8583e] text-sm text-center sm:text-left">© {new Date().getFullYear()} Rising Sun Token
                    ...
                    <span className="inline-flex sm:mt-0 mt-2 justify-center sm:justify-start">
                        <a className="text-[#f8583e]">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <a className="ml-3 text-[#f8583e]">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                    ...
                    <p className="text-[#f8583e] text-xs text-center sm:text-left mt-2 sm:mt-0">Powered by:&nbsp; 
